            ...
            <div className="container">
                <div className="w-full pb-3 border-b-[1px]">
                    <div className="w-3/5 m-auto flex gap-2 justify-between ">
                        ...
                        <div>
                            <svg className="m-auto" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 158 106">
                                <g fill="none" fill-rule="evenodd">
                        ...
                        <div>
                            <svg  className="m-auto" xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 101 120">
