                    ...
                    <AuthContext.Consumer>
                        {({ user }) => (user && (
                            <form action="">
                                ...
                                <input value={user.user.name ? user.user.name : " "} id="fullname" name="fullname" placeholder="نام کامل خود را وارد نمایید" class="block w-full p-3 mt-2 text-gray-900 bg-gray-100 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                                {/* TODO : check this */}
